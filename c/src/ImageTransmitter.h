...
private:
	...
	/**
	 * This is the number of lines that are to be sent in each UDP datagram.  By default ity is 1.
	 */
	int linesPerUDPDatagram=1;
...
public:
	 ...
	 * @param linesPerUDPDatagram This si the number of lines on each UDP datagram transmission.
	 */
	ImageTransmitter(char *machineName, int	port, int linesPerUDPDatagram);
